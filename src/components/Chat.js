		...
		return (
			<>
				<div
					...
					className="fixed bottom-10 right-10 bg-b2 w-400 p-3 text-white rounded-xl flex-row flex cursor-pointer justify-center"
				>
					<p className="mr-4 text-sm font-medium">Chat</p>
				</div>
			</>
		);
	} else {
